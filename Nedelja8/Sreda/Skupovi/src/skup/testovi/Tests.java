...
public class Tests {
    ...
    private void assertEquals(ArrayList<Integer> integers, ArrayList<Integer> intersection) {
    }
    ...
    @Test
    void UnionTest4() {
        assertEquals(new ArrayList<>(Arrays.asList(2, 4, 5, 6, 7, 8, 9, 10)), Zadaci.union(s2, s4));
    }
    ...
    private void assertEquals(int i, int ponavljanjeBroj) {
    }
...
//    }
    ...
    private void assertEquals(boolean b, boolean anagram) {
    }
}
